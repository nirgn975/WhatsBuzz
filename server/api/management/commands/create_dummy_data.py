...
from api.models import Trend, FacebookGame, FacebookGamesImage, FacebookUsername, FacebookProfileImage, \
    User, Tags
...
def create_trend_dummy_data():
    ...
    Trend.objects.get_or_create(
        ...
        banner_image=File(open('api/management/dummy_images/1.jpg', 'rb')),
    ...
    Trend.objects.get_or_create(
        ...
        publish=timezone.now(),
        banner_image=File(open('api/management/dummy_images/3.jpg', 'rb')),
    ...
    Trend.objects.get_or_create(
        ...
        publish=timezone.now(),
        banner_image=File(open('api/management/dummy_images/4.jpg', 'rb')),
        code='<script type="text/javascript" src="//cdn.playbuzz.com/widget/feed.js"></script><div '
             'class="pb_feed" data-embed-by="28ab7615-b158-460d-bb33-56ac88e36211" '
...
def create_facebook_games_dummy_data():
    ...
    post = FacebookGame.objects.get_or_create(
        ...
        age_categories='young',
        publish=timezone.now(),
        banner_image=File(open('api/management/dummy_images/2.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/drugs.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/pee.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/shimpanza.jpg', 'rb')),
    )
    ...
    post = FacebookGame.objects.get_or_create(
        ...
        age_categories='adults',
        publish=timezone.now(),
        banner_image=File(open('api/management/dummy_images/5.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/apple.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/bar-refali.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/bzooka.jpg', 'rb')),
    )
    FacebookGamesImage.objects.get_or_create(
        post=post[0],
        background_image=File(open('api/management/dummy_images/dokim.jpg', 'rb')),
    )
    FacebookUsername.objects.get_or_create(
        post=post[0],
        username='full_name',
